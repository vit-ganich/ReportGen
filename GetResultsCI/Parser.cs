...
namespace GetResultsCI
{
    class Parser
    {
        ...
        public static void Parse()
        {
            ...
            if(len == 0)
            {
                Logger.Log.Error("Unsupported format of TRX-filename (zero length).");
            ...
            Logger.Log.Info($"All tasks were finished successfully, report file was created in {ConfigReader.GetReportFolder()}");
        }
        ...
        {
            ReportWriter.WriteToReportFile("Autogenerated summary\n");
