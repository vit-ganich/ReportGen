...
namespace GetResultsCI
{
    class Parser
    {
        public static void Parse()
        {
            ...
            Reporter.ReportName = parsedFiles[0][len - 3];

            WriteTableHeader();

            foreach (var parsedFile in parsedFiles)
            {
                //var absFilePath = FileReader.JoinAbsFilePAth(parsedFile);
        ...
        {
            Reporter.WriteToReportFile("Autogenerated summary\n");
            Reporter.WriteToReportFile("QA_Client,CI Group,Test name,Build Version,Passed,Failed,Skipped,Result,Errors\n");
        }
        /// <summary>
